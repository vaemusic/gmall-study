package com.mallstudy.gmall.search;
...
public class GmallSearchServiceApplicationTests {
    ...
    public void contextLoads() throws IOException {
        ...
        //filter
        TermQueryBuilder termQueryBuilder = new TermQueryBuilder("skuAttrValueList.valueId","42");
        boolQueryBuilder.filter(termQueryBuilder);
        //must
        MatchQueryBuilder matchQueryBuilder=new MatchQueryBuilder("skuName","红米");
